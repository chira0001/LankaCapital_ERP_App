...
class _ReceiptPreviewPageState extends State<ReceiptPreviewPage> {
  ...
  Future<void> _printAndSave() async {
    ...
    try {
      ...
      debugPrint('[ReceiptPreviewPage] Collection ${widget.receiptId} saved after print.');
    } catch (e) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _row('Collection Date:', _formatDate(widget.collectionDate)),
                    _row('Print Date & Time:', _formatDateTime(DateTime.now())),
                    const Divider(height: 25),
                    _row('Loan Number:', widget.fileNumber),
                    const Divider(height: 25),
                    _row('Premium Amount:', 'LKR ${widget.premiumAmount.toStringAsFixed(2)}'),
                    _rowBold('Paid Amount:', 'LKR ${widget.paidAmount.toStringAsFixed(2)}'),
                    _row('Due Amount:', 'LKR ${widget.dueAmount.toStringAsFixed(2)}'),
                    const Divider(height: 25),
